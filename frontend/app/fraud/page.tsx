...
export default function FraudPage() {
  return (
    <Suspense fallback={<div className="p-4 font-mono font-bold text-xs">Loading Relationship Scope...</div>}>
      <div className="flex flex-col min-h-screen bg-[#FFFDF5] text-black font-['Space_Grotesk',sans-serif]">
        <Header activeTab="fraud" />
        <div className="flex flex-1 overflow-hidden">
          <SidebarNav activeTab="fraud" highRiskCount={42} />
